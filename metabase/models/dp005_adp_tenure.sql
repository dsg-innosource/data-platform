-- -------------------------------------------------------------------------------------------
-- ADP Tenure - Latest Snapshot
-- -------------------------------------------------------------------------------------------
-- METABASE URL: https://innosource.metabaseapp.com/model/331-adp-tenure
-- DESCRIPTION: The latest extract from ADP, used to calculate Net Gain, Termination
--              reasons, etc. Filters to the most recent snapshot_date only.
-- NOTE: DP-005 tag pending in Metabase
-- -------------------------------------------------------------------------------------------
select file_number,
       payroll_name,
       hire_date,
